...
class ErrorCode:
    ...
    CROSS_MIDNIGHT_NOT_ALLOWED = "CROSS_MIDNIGHT_NOT_ALLOWED"
    AMAP_SERVICE_ERROR = "AMAP_SERVICE_ERROR"
    PLACE_TRIP_MISMATCH = "PLACE_TRIP_MISMATCH"
...
DEFAULT_STATUS: dict[str, int] = {
    ...
    ErrorCode.ITEM_TIME_CONFLICT: 409,
    ...
    ErrorCode.CROSS_MIDNIGHT_NOT_ALLOWED: 422,
    ErrorCode.AMAP_SERVICE_ERROR: 502,
    ErrorCode.PLACE_TRIP_MISMATCH: 422,
    ErrorCode.PREVIEW_TOKEN_INVALID: 422,
}
